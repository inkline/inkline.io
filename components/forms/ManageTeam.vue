    ...
    <IForm v-model="form">
        ...
        >
            <div class="_margin-right:2 _font-size:sm">
                <ul>
                    <li>
                        Any applicable taxes and discounts will be applied on your monthly invoice.
                        Prices exclude applicable taxes and VAT (varies based on your country).
                        Learn more
                    </li>
                    <li>
                        By clicking
                        {{ t(`forms.manageTeam.submit.${team ? 'update' : 'create'}`) }}, you agree
                        to the Terms of service agreements.
                    </li>
                    <li>
