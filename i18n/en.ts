export default {
    ...
    pageNavigation: {
        footer: {
            cta: 'Caught a mistake or want to contribute to the documentation?',
    ...
    pages: {
        index: {
            header: {
                ...
                news: {
                    badge: 'New in v4.0',
                    headline: 'Configuration file, design tokens, toast notifications and more!'
                }
            },
            designSystem: {
                ...
                titleHighlight: 'Fast.',
                description:
                    'Make components look the way you want, without the hassle. More time to focus on building a great experience for your customers.',
