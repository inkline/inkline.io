...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ITable/examples/basic.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ITable/examples/bordered.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ITable/examples/striped.raw.vue" lang="vue"} -->
::
...
::ContentTabs
#preview
:ContentPreview{src="/components/ITable/examples/hovered" off="layout"}
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ITable/examples/hovered.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ITable/examples/responsive.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ITable/examples/color-variants.raw.vue" lang="vue"} -->
::
