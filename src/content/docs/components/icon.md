...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IIcon/examples/icons.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IIcon/examples/color-variants.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IIcon/examples/size-variants.raw.vue" lang="vue"} -->
::
