...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IHamburgerMenu/examples/basic.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IHamburgerMenu/examples/color-variants.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IHamburgerMenu/examples/animation.raw.vue" lang="vue"} -->
::
