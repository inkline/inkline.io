...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ITabs/examples/advanced.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ITabs/examples/stretch.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ITabs/examples/color-variants.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ITabs/examples/size-variants.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ITabs/examples/basic.raw.vue" lang="vue"} -->
::
