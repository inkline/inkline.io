...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IBreadcrumb/examples/basic.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IBreadcrumb/examples/dynamically-generated.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IBreadcrumb/examples/color-variants.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IBreadcrumb/examples/size-variants.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IBreadcrumb/examples/routing.raw.vue" lang="vue"} -->
::
