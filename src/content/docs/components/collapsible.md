...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ICollapsible/examples/basic.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ICollapsible/examples/header.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ICollapsible/examples/default-open.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ICollapsible/examples/accordion.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ICollapsible/examples/color-variants.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ICollapsible/examples/size-variants.raw.vue" lang="vue"} -->
::
