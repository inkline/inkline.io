...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ILayout/examples/basic.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ILayout/examples/content-header.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ILayout/examples/content-header-footer.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ILayout/examples/content-with-left-aside-header-footer.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ILayout/examples/content-with-right-aside-header-footer.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ILayout/examples/content-with-left-and-right-asides-header-footer.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ILayout/examples/left-aside-with-content-header-footer.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ILayout/examples/right-aside-with-content-header-footer.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/ILayout/examples/left-and-right-asides-with-content-header-footer.raw.vue" lang="vue"} -->
::
