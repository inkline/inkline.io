...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IToggle/examples/basic.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IToggle/examples/readonly.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IToggle/examples/disabled.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IToggle/examples/color-variants.raw.vue" lang="vue"} -->
::
...
#vue
<!-- Autodocs{src="@inkline/inkline/lib/components/IToggle/examples/size-variants.raw.vue" lang="vue"} -->
::
