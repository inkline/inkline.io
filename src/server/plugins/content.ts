...
const codeFilePaths = [
    resolve(inklineConfigPath, 'lib', 'templates', 'defaults.ts'),
    ...glob.sync(resolve(inklinePath, 'lib', 'stories', '**', '*.raw.vue')),
    ...glob.sync(resolve(inklinePath, 'lib', 'components', '**', 'examples', '*.raw.vue'))
];
