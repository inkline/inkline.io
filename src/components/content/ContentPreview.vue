            ...
            try {
                ...
                if (pathParts.value[0] === 'components') {
                    componentModule = await import(
                        `../../node_modules/@inkline/inkline/lib/${pathParts.value[0]}/${pathParts.value[1]}/examples/${pathParts.value[3]}.vue`
                    );
                } else {
                    if (pathParts.value.length === 5) {
                        componentModule = await import(
                            `../../node_modules/@inkline/inkline/lib/stories/${pathParts.value[1]}/${pathParts.value[2]}/${pathParts.value[3]}/${pathParts.value[4]}.vue`
                        );
                    } else {
                        componentModule = await import(
                            `../../node_modules/@inkline/inkline/lib/stories/${pathParts.value[1]}/${pathParts.value[2]}/${pathParts.value[3]}.vue`
                        );
                    }
                }
