...
const colorSwitcherComponent = markRaw(INavItem);
...
const isActiveItem = computed<Record<string, boolean>>(() => ({
                    ...
                    >
                        ...
                        <template #body>
                            <IDropdownItem
                                ...
                                :key="subPage.title"
                                :to="localePath(subPage.url as string)"
                            >
                                {{ subPage.title }}
                            </IDropdownItem>
                        </template>
...
.app-navbar {
    ...
    @include config.breakpoint-up('lg') {
        .app-sidebar-navigation,
        .app-sidebar-apps {
            display: none;
        }
