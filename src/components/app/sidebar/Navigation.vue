...
const menu = computed<CollapsibleNavigationPage[]>(() =>
    props.navigation.map((category, categoryIndex) => ({
        ...category,
...
.app-sidebar-navigation {
    --sidebar--item--padding-top: 0;
    --sidebar--item--padding-bottom: 0;
    --sidebar--item--padding-left: 0;
